...
import Foundation
struct IndividualStaffModel : Codable
{
	let status_code : Int?
	let message : String?
	let data : IndividualStaffDetails?
...
struct IndividualStaffDetails : Codable {
    let staffDetailsData : [IndividualStaffDetailsData]?
...
struct IndividualStaffDetailsData : Codable {
    let staff_id : Int?
    let token_id : String?
    let premise_id : Int?
